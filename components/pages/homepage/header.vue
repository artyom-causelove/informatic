  ...
  <div class="header">
    ...
    <div class="wrapper-schedule">
      <template v-for="(work, index) in parsedWorks">
        <schedule-carda v-if="work"
          :data="work"
          textColor="#FFFFFF"
          image="/pepper.png"
          imageHard="/fire.png"
          :fields="workFieldLinks"
          :disabled="work.tariff !== user.tariff"
          :options="{ color: '#EF3A5F' }"
          disabled-text="SENIOR ONLY!"
          class="card card-work" :class="{ 'card-today': index === 3 }"
        />
